    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                diarization = diarizer(wav_audio_path, num_speakers=2)
            ...
            for turn, _, speaker in diarization.itertracks(yield_label=True):
                ...
                break  # We just need the first occurrence

            # Create mapping based on first speaker
            #  First-Speaker Loc
            SPEAKER_MAP = {
                first_speaker: "Interviewer",
                "SPEAKER_01" if first_speaker == "SPEAKER_00" else "SPEAKER_00": "Candidate"
            }
            ...
            for turn, _, speaker in diarization.itertracks(yield_label=True):
                ...
                try:
                    ...
                    res = transcription_model.generate(
                        ...
                        language="en",    # 'auto': Auto language detection, otherwise: en, zh, yue 
